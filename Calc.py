...
def result_calc():
    ...
    if operator == '+':
        res = op.add(first_num,second_num)
    elif operator == '-':
        res = op.subtract(first_num,second_num)
    elif operator == '*':
        res = op.multiply(first_num,second_num)
    elif operator == '/':
        res = op.devide(first_num,second_num)
